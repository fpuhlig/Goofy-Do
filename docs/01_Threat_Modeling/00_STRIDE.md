...
### 2.3 CI/CD Pipeline zu Kubernetes-Cluster
| ID   | STRIDE | Beschreibung                                              | Beispielangriff                                                                                                         | Voraussetzungen                                                          | Gegenmaßnahmen                                                                                                                 | Status        |
|------| --- |-----------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|---------------|
| CK01 | Spoofing | Angreifer gibt sich als legitimer CI/CD-Service aus       | Gefälschte Deployments ins Cluster                                                                                      | Keine strikte Registry-Allowlist, fehlende TLS-Validierung               | Registry-Allowlist, TLS, Image-Signaturen                                                                                      | Implementiert |
| CK02 | Tampering | Manipulation von Deployments/Manifests                    | „:latest“ wird nachträglich auf ein bösartiges Image geleitet, kompromittiertes Registry-Account überschreibt ein Image | fehlendes Image-Signing, Registry-Write-Rechte zu weit                   | Image Signing + SBOM, Admission Controller erzwingt Signatur/Digest/Registry, Least-Privilege für Registry-Push                | Implementiert |
| CK03 | Repudiation | Deployments nicht nachvollziehbar                         | Unklar, wer wann was deployed hat                                                                                       | Kein Deployment-Logging, keine Signaturen                                | Deployment-Audit-Logs, GitOps-Ansatz mit PR-Historie                                                                           | Implementiert |
| CK04 | Information disclouser | Offenlegung von Registry-Credentials oder Image-Metadaten | Secrets in Manifests werden im Klartext ausgelesen                                                                      | Langlebige Credentials, Secrets in Klartext                              | Secret Management + Rotation, least-privilege Registry-Rechte, Secret Scan                                                     | Implementiert |
| CK05 | Denial of service | Deployment-/Pull-Prozess überlastet Registry oder Cluster (Pull-Storm), Images können nicht mehr gezogen werden         | Angreifer/Fehler triggert viele Rollouts, Nodes ziehen parallel große Images, Rate-Limits/Timeouts  | Keine Pull-Rate-Limits/Backoff sehr große Images; kein Caching/Mirror    | Registry Mirror/Cache, Pull-Backoff/Timeouts, Schutz vor unkontrollierten Deployments (RBAC + GitOps-Gates) | Implementiert |
| CK06 | Elevation of privilege | Einschleusen eines Images, das im Cluster höhere Rechte erlangt              | Bösartiges Image läuft als privileged, mountet HostPaths, liest ServiceAccount Token und bewegt sich lateral im Cluster                   | Schwache Pod Security, zu weite RBAC, Überprivilegierte Service-Accounts | Least-Privilege Service-Accounts für CI/CD, RBAC-Prinzip „deny by default“, regelmäßige Rechte-Reviews                        |  |